				...
				<div class="col">
					<div class="input-group" style="height: 40px;">
						...
						<input type="text" id="startDate" class="form-control"
							name="itemStartDate" value="${itemList.itemStartDate.split('T')[0]} ${itemList.itemStartDate.split('T')[1]}" readonly>
					</div>
				</div>
			</div>
			<div class="row my-2">
				<div class="col">
					<div class="input-group" style="height: 40px;">
						...
						<input type="text" id="endDate" class="form-control" 
							name="itemEndDate" value="${itemList.itemEndDate.split('T')[0]} ${itemList.itemEndDate.split('T')[1]}" readonly>
					</div>
				</div>
			</div>
        <div class="row my-2">
